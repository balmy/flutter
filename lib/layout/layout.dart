...
meters above sea level, it is one of the larger Alpine Lakes. A gondola ride from Kandersteg, 
followed by a half-hour walk through pastures and pine forest, leads you to the lake, 
...
and riding the summer toboggan run.
    ...
    return new MaterialApp(
      title: 'layout practise',
      home: new Scaffold(
        appBar: new AppBar(
          title: new Text('layout practise'),
        ),
        body: new ListView(
          children: <Widget>[
            new Image.asset(
